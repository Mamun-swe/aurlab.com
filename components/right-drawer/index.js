...
export const RightDrawer = (props) => {
    return (
        <div className={props.hidden ? `${props.hidden}:hidden` : ""}>
            ...
            <div className={
                props.show ?
                    "fixed top-0 right-0 w-[100%] lg:w-[600px] h-[100vh] shadow-lg bg-white z-[100] transition-all duration-300" :
                    "fixed top-0 right-[-100%] lg:w-[600px] h-[100vh] shadow-lg bg-white z-[100] transition-all duration-300"
            }
            >
                {props.children}
            </div>
