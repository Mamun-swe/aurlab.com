    ...
    async (userName, page) => {
      try {
        ...
        if (response.status === 200) {
          ...
          setTotalRows(
            response.data.pagination ? response.data.pagination.total_items : 10
          );
        }
  ...
  const columns = [
    {
      ...
      width: "100px",
      selector: (row) =>
        row.publicationDate ? dateTodate(row.publicationDate) : "N/A",
    },
    {
      name: "Category",
      sortable: true,
  ...
  return (
    <div>
      ...
      <div className="container mx-auto mt-[81px] py-[30px]">
        ...
        {!isLoading && !user ? (
          <NoContent message="Account not available." />
        ) : null}
          ...
          <div className="lg:flex">
            ...
            {!isLoading && user ? (
              <div className="w-full lg:!w-[350px] mb-10 lg:mb-0 lg:pr-5 overflow-x-hidden">
                ...
                <div>
                  {/* About */}
                  <Text className="text-sm font-normal leading-relaxed text-gray-500 mb-3">
                    {user.about}
                  </Text>
          ...
          {details.status && details.data ? (
            <>
                  ...
                  {details.data.authors && details.data.authors.length > 0
                    ? details.data.authors.map((item, i) => (
                        <p className="text-xs mr-1" key={i}>
                          {item}
                          {i + 1 < details.data.authors.length ? "," : ""}
                        </p>
                      ))
                    : null}
                </div>
              ...
              <div className="flex gap-4 mb-5">
                ...
                <div className="grow inline-flex">
                  {details.data.publicationDate && (
                    <p className="text-xs">
                      {dateTodate(details.data.publicationDate)}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="flex gap-4 mb-5">
                ...
                <div className="grow inline-flex">
                  <p className="text-xs">{details.data.citations || 0}</p>
                </div>
              </div>
              ...
              <div className="text-center">
                <a href={details.data.file} target="_blank">
