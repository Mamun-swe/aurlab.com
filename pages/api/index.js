...
export const ResearcherList = async (page, limit) => {
  return await publicRequest.get(
    `${BASE_URL}/public/researcher?page=${page}&limit=${limit}`
  );
};

/* Public category list */
export const categoryList = async (query) => {
  return await publicRequest.get(`${BASE_URL}/public/category`);
};

/** Public search publication */
export const searchPublications = async (data) => {
  return await publicRequest.post(
    `${BASE_URL}/public/publications/search`,
    data
  );
};
...
export const ResearcherSearch = async (query) => {
  return await publicRequest.get(
    `${BASE_URL}/public/researcher/search/profile?query=${query}`
  );
};
...
export const ResearcherPublications = async (username, page, limit) => {
  return await publicRequest.get(
    `${BASE_URL}/public/researcher/publications/${username}?page=${page}&limit=${limit}`
  );
};
...
export const UpdateProfileInfo = async (data) => {
  return await privateRequest.put(
    `${BASE_URL}/researcher/profile/update`,
    data
  );
};
...
export const UpdateUsername = async (data) => {
  return await privateRequest.put(
    `${BASE_URL}/researcher/profile/update-username`,
    data
  );
};
...
export const AddWork = async (data) => {
  return await privateRequest.put(
    `${BASE_URL}/researcher/profile/add-work`,
    data
  );
};
...
export const RemoveWork = async (id) => {
  return await privateRequest.delete(
    `${BASE_URL}/researcher/profile/remove-work/${id}`
  );
};
...
export const AddEducation = async (data) => {
  return await privateRequest.put(
    `${BASE_URL}/researcher/profile/add-education`,
    data
  );
};
...
export const RemoveEducation = async (id) => {
  return await privateRequest.delete(
    `${BASE_URL}/researcher/profile/remove-education/${id}`
  );
};
...
export const AddSocial = async (data) => {
  return await privateRequest.put(
    `${BASE_URL}/researcher/profile/add-social`,
    data
  );
};
...
export const RemoveSocial = async (id) => {
  return await privateRequest.delete(
    `${BASE_URL}/researcher/profile/remove-social/${id}`
  );
};
...
export const Publications = async (page, limit) => {
  return await privateRequest.get(
    `${BASE_URL}/researcher/publication?page=${page}&limit=${limit}`
  );
};
...
export const PublicationUpdate = async (id, data) => {
  return await privateRequest.put(
    `${BASE_URL}/researcher/publication/${id}`,
    data
  );
};
